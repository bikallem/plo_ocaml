...
(* OASIS_START *)
(* DO NOT EDIT (digest: ddc0c1a5ad66a8bdc472acdd39002604) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/neolem/plo_ocaml_LL1";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "* PL/0 language - as described by Niklaus Wirth - implementation * Parser(hand crafted LL1) implemented in Ocaml. * The backend will eventually target LLVM or NASM assembly."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "plo.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest =
       Some "\214\244\158\149M\143\198zP\209\129\232\237\209\006l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
